...
# def init_vector_db():
policy_info_data=pd.read_excel("/vda2/wangshihang/LLM_api_combine/mcp_lecture_project/project2_Agent_SDK+MCP_materials/投资政策.xlsx")
...
print(document_list)
#%%
qwen_db=ChromaDBWithQwen(persist_directory="/vda2/wangshihang/LLM_api_combine/mcp_lecture_project/project2_Agent_SDK+MCP_materials/db_data")
print(qwen_db)
#%%
