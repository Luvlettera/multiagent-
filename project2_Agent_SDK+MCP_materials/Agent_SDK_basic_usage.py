...
import sys
sys.path.append("/vda2/wangshihang/LLM_api_combine/mcp_lecture_project/project2_Agent_SDK+MCP_materials/project2_Agent_SDK+MCP_material")
set_tracing_disabled(False) # 是否跟踪智能体运行过程
# 设置DeepSeek模型作为Agent的驱动模型：.env
load_dotenv()
server_url=os.getenv("server_url") #server_url="192.110.223.33"
external_client = AsyncOpenAI(
    base_url = "https://api.deepseek.com",
    api_key="sk-9d8729d63b484013b0b99b55cf9cb248") #DEEPSEEK_API_KEY="" os.getenv("DEEPSEEK_API_KEY"))
...
def predict_future_7data(stock_name):
    if stock_name=="上证指数":
        stock_data = pd.read_excel('/vda2/wangshihang/LLM_api_combine/mcp_lecture_project/project1_stock_counselor/stock_data.xlsx',
