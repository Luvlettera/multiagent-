...
async def LLM_replay(prompt_template,messages):
    ...
    message:大模型调用的用户输入
    """
    llm_client =AsyncOpenAI(api_key=os.getenv("API_KEY"), base_url="https://dashscope.aliyuncs.com/compatible-mode/v1") #"sk-17dea6503de44d2d983347cc254243b2"  config.aliyun_api_key config.api_key config.base_url
